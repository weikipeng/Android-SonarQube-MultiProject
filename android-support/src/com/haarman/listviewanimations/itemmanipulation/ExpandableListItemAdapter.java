...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> {
	...
	private View mPrevExpandedView;
	...
	public void setIniOpenedPosition(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TitleViewOnClickListener listener = null;
		...
		if (titleView != viewHolder.titleView) {
			...
			if (mActionViewResId == 0) {
				listener = new TitleViewOnClickListener(viewHolder.contentParent);
		...
		if (mOpenedPosition > -1 && mOpenedPosition == position && listener != null) {
			listener.onClick(titleView);
		}
	...
	public void setOnTitleViewClickListener(OnTitleViewClickListener l) {
		mOnTitleViewClickListener = l;
	}
	
	public static abstract interface OnTitleViewClickListener {
		public abstract void onTitleViewClick(View current, View previous, boolean isExpanded);
	}
	...
	private class TitleViewOnClickListener implements View.OnClickListener {
		...
		public void onClick(View view) {
			...
			if (mOnTitleViewClickListener != null) {
				mOnTitleViewClickListener.onTitleViewClick(view, mPrevExpandedView, isVisible);
				mPrevExpandedView = view;
			}
		}
	}
