...
public class AsyncHttpClient {
    ...
    public static String AsyncHttpClient_UA = "bang-android version:2.2";
    ...
    public AsyncHttpClient() {
        ...
        //HttpHost proxy = new HttpHost("10.1.2.206", 80);
//        HttpHost proxy = new HttpHost("122.112.13.37", 80); 
//        httpParams.setParameter(ConnRoutePNames.DEFAULT_PROXY, proxy);
        ...
        HttpProtocolParams.setUserAgent(httpParams,AsyncHttpClient.AsyncHttpClient_UA);
        //HttpProtocolParams.setUserAgent(httpParams, String.format("bang-android version: %s", VERSION));
    ...
    public AsyncHttpClient(Boolean isHasProxy) {
    	
        BasicHttpParams httpParams = new BasicHttpParams();
        
        if(isHasProxy){
//        HttpHost proxy = new HttpHost("10.1.2.206", 80);
//        HttpHost proxy = new HttpHost("119.57.80.37", 80); 
//        httpParams.setParameter(ConnRoutePNames.DEFAULT_PROXY, proxy);
        }
