...
FCloseLog.d(TAG, "You tried to add a listener to a non-existing request.");
            return;
        }
...
FCloseLog.d(TAG,"This request is already in progress. Adding the new listener to it.");
...
FCloseLog.d(TAG, "Creating a new request and adding the listener to it.");
